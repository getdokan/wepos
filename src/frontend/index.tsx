...
const weposTokens: ThemeTokens = {
  ...
  primary: 'oklch(0.5110 0.2620 276.966)',
  primaryForeground: 'oklch(0.9850 0 0)',
  secondary: 'oklch(0.9700 0.0100 276.966)',
  secondaryForeground: 'oklch(0.5110 0.2620 276.966)',
  muted: 'oklch(0.9700 0.0100 276.966)',
  ...
  info: 'oklch(0.6230 0.2140 255.0900)',
  infoForeground: 'oklch(1.0000 0 0)',
  border: 'oklch(0.9220 0.0050 276.966)',
  input: 'oklch(0.9220 0.0050 276.966)',
  ring: 'oklch(0.5110 0.2620 276.966)',
  ...
  sidebar: 'oklch(0.9850 0.0050 276.966)',
  sidebarForeground: 'oklch(0.1450 0 0)',
  sidebarPrimary: 'oklch(0.5110 0.2620 276.966)',
  sidebarPrimaryForeground: 'oklch(0.9850 0 0)',
  sidebarAccent: 'oklch(0.9700 0.0100 276.966)',
  sidebarAccentForeground: 'oklch(0.5110 0.2620 276.966)',
  sidebarBorder: 'oklch(0.9220 0.0050 276.966)',
  sidebarRing: 'oklch(0.5110 0.2620 276.966)',
  fontSans:
...
const weposDarkTokens: ThemeTokens = {
  ...
  card: 'oklch(0.1950 0 0)',
  cardForeground: 'oklch(0.9850 0 0)',
  popover: 'oklch(0.2690 0 0)',
  popoverForeground: 'oklch(0.9850 0 0)',
  primary: 'oklch(0.6200 0.2100 276.966)',
  primaryForeground: 'oklch(0.9850 0 0)',
  secondary: 'oklch(0.2690 0.0150 276.966)',
  ...
  info: 'oklch(0.6230 0.2140 255.0900)',
  infoForeground: 'oklch(1.0000 0 0)',
  border: 'oklch(0.2750 0.0100 276.966)',
  input: 'oklch(0.3250 0.0150 276.966)',
  ring: 'oklch(0.5500 0.1500 276.966)',
  chart1: 'oklch(0.8100 0.1000 252)',
  chart2: 'oklch(0.6200 0.1900 260)',
  chart3: 'oklch(0.5500 0.2200 263)',
  chart4: 'oklch(0.4900 0.2200 264)',
  chart5: 'oklch(0.4200 0.1800 266)',
  sidebar: 'oklch(0.1800 0.0150 276.966)',
  sidebarForeground: 'oklch(0.9850 0 0)',
  sidebarPrimary: 'oklch(0.6200 0.2100 276.966)',
  sidebarPrimaryForeground: 'oklch(0.9850 0 0)',
  sidebarAccent: 'oklch(0.2690 0.0200 276.966)',
  sidebarAccentForeground: 'oklch(0.9850 0 0)',
  sidebarBorder: 'oklch(0.2750 0.0100 276.966)',
  sidebarRing: 'oklch(0.5500 0.1500 276.966)',
  fontSans:
    "ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
  fontSerif: "ui-serif, Georgia, Cambria, 'Times New Roman', Times, serif",
  fontMono:
